...
/***/ function(module, exports, __webpack_require__) {
	...
	var nodeEvents = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Creates Files
	var uploadNode = function uploadNode(success, failure, data) {
	  // console.log(data);
	  $.ajax({
	    method: 'POST',
	...
	var getAllNodes = function getAllNodes(success, failure) {
	  $.ajax({
	...
	var getDirectory = function getDirectory(success, failure, id) {
	  $.ajax({
	...
	var editNode = function editNode(success, failure, data, nodeId) {
	  console.log(data);
	  $.ajax({
	    method: "PATCH",
	...
	var deleteNode = function deleteNode(success, failure, nodeId) {
	  console.log(nodeId);
	  $.ajax({
	    method: "DELETE",
	    url: app.server.api + '/nodes/' + nodeId,
	...
	var createFolder = function createFolder(success, failure, data) {
	  $.ajax({
	    method: 'POST',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var authApiNodes = __webpack_require__(8);
	var authUi = __webpack_require__(7);
	var display = __webpack_require__(9);
	var nodeUi = __webpack_require__(31);
	var app = __webpack_require__(6);

	var traverseBreadcrumb = function traverseBreadcrumb(e) {
	  $(e.target).parent().nextAll().remove();
	  $(e.target).parent().addClass('active');
	  $(e.target).contents().unwrap();
	};

	var nodeEventHandlers = function nodeEventHandlers() {
	  ...
	  $('#edit-tag-form').on('submit', function (e) {
	    e.preventDefault();
	    var data = getFormFields(this);
	    var nodeId = $('.edit-tags-btn').attr('data-id');
	  ...
	  $('.all-nodes').on('click', function (e) {
	    ...
	    if (dataType === "file") {
	      var external_link = $(e.target).attr('data-location');
	      ...
	      // window.location.assign($(e.target).attr('data-location'));
	        ...
	        var text = $('.breadcrumb .active').text();
	...
	module.exports = {
	  nodeEventHandlers: nodeEventHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var uploadNodeSuccess = function uploadNodeSuccess() {
	...
	var uploadNodeFailure = function uploadNodeFailure(error) {
	  console.error(error);
	...
	var createFolderSuccess = function createFolderSuccess() {
	...
	module.exports = {
	  success: success,
	  failure: failure,
	  uploadNodeSuccess: uploadNodeSuccess,
	  uploadNodeFailure: uploadNodeFailure,
	  editNodeSuccess: editNodeSuccess,
	  deleteNodeSuccess: deleteNodeSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["getFormFields"] = __webpack_require__(44);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
...
/***/ function(module, exports) {
	...
	var getFormFields = function getFormFields(form) {
	  ...
	  for (var i = 0; i < elements.length; i++) {
	    ...
	    var type = e.nodeName.toUpperCase() === 'INPUT' ? e.getAttribute('type').toUpperCase() : 'TEXT';
	    if (type !== 'RADIO' && type !== 'CHECKBOX' || e.checked) {
